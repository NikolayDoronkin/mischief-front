...
export class ProjectService {
  ...
  getTeamMembers(id: string, page: number, size: number, search: string) {
    return this.http.get('http://localhost:8081/project/' + id + '/members' + '?searchFilter=' + search +  '&page=' + page + '&size=' + size)
  }
